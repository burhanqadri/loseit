    ...
    for row in csv_reader:
        ...
        if line_count == 0:
            ...
            try:
                ...
                con_ratio = consistency / duration
                ...
                if first_date in start_dates:
                    ...
                    duration_dates[first_date].append(duration)
                    consistency_dates[first_date].append(consistency)
                else:
                    start_dates[first_date] = 1
                    duration_dates[first_date] = [duration]
                    consistency_dates[first_date] = [consistency]
    ...
    for key in mosyears:
        try:
            print(statistics.mean(
                consistency_dates[key]))

            # print(key, start_dates[key], statistics.mean(
            #     duration_dates[key]), statistics.median(duration_dates[key]), statistics.mean(
            #     consistency_dates[key]), statistics.median(consistency_dates[key]))
        except:
            print(0)
